      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {projects.map((project, i) => (
            <SectionReveal key={project.className} delay={i * 0.08}>
              <motion.div
                whileHover={{ y: -2 }}
                transition={{ duration: 0.2 }}
                className="group rounded-lg border border-slate-700/50 bg-slate-800/30 font-mono text-sm transition-all duration-300 hover:border-slate-600"
              >
                {/* Title bar */}
                ...
                <div className="p-5">
                  ...
                  <div className="mt-1.5 pl-6">
                    ...
                    <p className="leading-relaxed text-emerald-400/80">
                      {project.description}
                    </p>
                    <p className="text-emerald-400/80">"""</p>
                  </div>
