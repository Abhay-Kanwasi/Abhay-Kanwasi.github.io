    ...
    projects: [
      {
        ...
        bullets: [
          ...
          'Built an in-app version upgrade and SSL management system for a hospital software platform — enabling admins to upload version packages (tar.gz), view upgrade details with guided instructions, resume interrupted upgrades via status tracking (file_saved/upgrade_proceed/completed/failed), and securely upload and configure SSL certificates through a dedicated settings module.',
        ],
        stack: ['Python', 'Django', 'DRF', 'React', 'LDAP', 'Active Directory'],
      ...
      },
      {
        ...
        bullets: [
          ...
          'Led feature development and mentored interns, delivering mobile UI improvements (profile, hospital profile, password change flows) while reviewing pull requests and enforcing code quality standards.',
        ],
        stack: ['Python', 'Django', 'DRF', 'React', 'TypeScript', 'PostgreSQL'],
        liveLink: '',
        sourceCode: '',
      },
      {
        ...
        bullets: [
          ...
          'Done POC and implemented streamlined PDF processing with Google Cloud Vision API in batch processing.',
        ],
        stack: ['Python', 'Django', 'Google Cloud Storage', 'Cloud Run', 'Docker', 'Cloud Functions', 'Google Vision API'],
